...
float triangleArea(vec2 v1, vec2 v2, vec2 v3)
{
...
void main(void)
{
	highp vec2 v1 = vec2(0.0, v_TexRect.w+1.0);
	highp vec2 v2 = vec2(v_TexRect.z / 2.0, 0.0);
	highp vec2 v3 = vec2(0.0, v_TexRect.w);
